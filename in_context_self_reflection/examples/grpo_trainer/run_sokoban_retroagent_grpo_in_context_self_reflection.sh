...
export RUN_NAME=agent_training_grpo_rl_sokoban_qwen25_7b_instruct_zero_intrinsic_rewards_mem_retrieve_similarity_utility_ucb_half_group_gt_reflection_large_penalty_gen2048_date0222
export HDFS_CHECKPOINT_PATH=./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_sokoban/ckpts
mkdir -p $HDFS_CHECKPOINT_PATH
export HYDRA_FULL_ERROR=1

export REFLECTION_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_sokoban/memory_cache/agent_training_grpo_rl_sokoban_qwen25_7b_instruct_zero_intrinsic_rewards_mem_retrieve_similarity_utility_ucb_half_group_gt_reflection_large_penalty_gen2048_date0222/sokoban_reflections.json"
export REFLECTION_ANALYSIS_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_sokoban/memory_cache/agent_training_grpo_rl_sokoban_qwen25_7b_instruct_zero_intrinsic_rewards_mem_retrieve_similarity_utility_ucb_half_group_gt_reflection_large_penalty_gen2048_date0222/reflect_analysis.jsonl"
export TRAJECTORY_ANALYSIS_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_sokoban/memory_cache/agent_training_grpo_rl_sokoban_qwen25_7b_instruct_zero_intrinsic_rewards_mem_retrieve_similarity_utility_ucb_half_group_gt_reflection_large_penalty_gen2048_date0222/trajectory_analysis.jsonl"
