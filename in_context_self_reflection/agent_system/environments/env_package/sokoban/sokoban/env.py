...
from agent_system.environments.env_package.sokoban.sokoban.room_utils import generate_room, get_shortest_action_path
import copy
...
class SokobanEnv(BaseDiscreteActionEnv, GymSokobanEnv):
    ...
    def reset(self, seed=None):
        ...
        # FIX: 'break' was outside loop. Added 'while True' loop.
