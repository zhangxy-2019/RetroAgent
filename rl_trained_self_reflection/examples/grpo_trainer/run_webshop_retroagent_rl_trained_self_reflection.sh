...
export WANDB_NAME="retroagent_rl_trained_self_reflection"
export WANDB_OFFICIAL=1
wandb offline 

export MODEL_PATH=./models/meta-llama/Llama-3.1-8B-Instruct
export RUN_NAME=grpo_llama31_8b_instruct_retroagent_rl_trained_self_reflection
export HDFS_CHECKPOINT_PATH=./agent_training/llama31_8b_instruct_webshop/ckpts
mkdir -p $HDFS_CHECKPOINT_PATH
export HYDRA_FULL_ERROR=1

export REFLECTION_FILE="./agent_training/llama31_8b_instruct_webshop/memory_cache/grpo_llama31_8b_instruct_retroagent_rl_trained_self_reflection/webshop_reflections.json"
export REFLECTION_ANALYSIS_FILE="./agent_training/llama31_8b_instruct_webshop/memory_cache/grpo_llama31_8b_instruct_retroagent_rl_trained_self_reflection/reflect_analysis.jsonl"
export TRAJECTORY_ANALYSIS_FILE="./agent_training/llama31_8b_instruct_webshop/memory_cache/grpo_llama31_8b_instruct_retroagent_rl_trained_self_reflection/trajectory_analysis.jsonl"
