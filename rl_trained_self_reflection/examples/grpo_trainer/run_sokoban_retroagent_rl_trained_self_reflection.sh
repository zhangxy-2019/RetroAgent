...
# WANDB (optional)
export PROJECT_NAME=agent_project
export WANDB_API_KEY=
export WANDB_PROJECT="agent_training_llama31_8b_instruct"
export WANDB_NAME="retroagent_rl_trained_self_reflection_sokoban"
export WANDB_OFFICIAL=1
wandb offline 

export MODEL_PATH=zhangxiaoying/models/meta-llama/Llama-3.1-8B-Instruct
export RUN_NAME=retroagent_rl_trained_reflection_llama31_8b_instruct_sokoban
export HDFS_CHECKPOINT_PATH=./xiaoyingzhang/agent_training/llama31_8b_instruct_sokoban/ckpts
mkdir -p $HDFS_CHECKPOINT_PATH
export HYDRA_FULL_ERROR=1

export REFLECTION_FILE="./xiaoyingzhang/agent_training/llama31_8b_instruct_sokoban/memory_cache/retroagent_rl_trained_reflection_llama31_8b_instruct_sokoban/sokoban_reflections.json"
export REFLECTION_ANALYSIS_FILE="./xiaoyingzhang/agent_training/llama31_8b_instruct_sokoban/memory_cache/retroagent_rl_trained_reflection_llama31_8b_instruct_sokoban/reflect_analysis.jsonl"
export TRAJECTORY_ANALYSIS_FILE="./xiaoyingzhang/agent_training/llama31_8b_instruct_sokoban/memory_cache/retroagent_rl_trained_reflection_llama31_8b_instruct_sokoban/trajectory_analysis.jsonl"
...
python3 -m verl.trainer.main_ppo \
    ...
    +algorithm.reflect_loss_weight=1.0 \
