...
export WANDB_PROJECT="agent_training"
export WANDB_NAME="retroagent_rl_trained_self_reflection_llama31_8b_instruct"
export WANDB_OFFICIAL=1
wandb offline 
export MODEL_PATH=./models/meta-llama/Llama-3.1-8B-Instruct
export RUN_NAME=retroagent_rl_trained_self_reflection_llama31_8b_instruct
export HDFS_CHECKPOINT_PATH=./xiaoyingzhang/llama31_8b_instruct_minesweeper/ckpts
mkdir -p $HDFS_CHECKPOINT_PATH
export HYDRA_FULL_ERROR=1
export REFLECTION_FILE="./xiaoyingzhang/llama31_8b_instruct_minesweeper/memory_cache/retroagent_rl_trained_self_reflection_llama31_8b_instruct/minesweeper_reflections.json"
export REFLECTION_ANALYSIS_FILE="./xiaoyingzhang/llama31_8b_instruct_minesweeper/memory_cache/retroagent_rl_trained_self_reflection_llama31_8b_instruct/reflect_analysis.jsonl"
export TRAJECTORY_ANALYSIS_FILE="./xiaoyingzhang/llama31_8b_instruct_minesweeper/memory_cache/retroagent_rl_trained_self_reflection_llama31_8b_instruct/trajectory_analysis.jsonl"
