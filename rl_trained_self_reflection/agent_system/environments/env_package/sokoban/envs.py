...
def build_sokoban_envs(
        ...
        is_train=True,
        env_kwargs=None):
    return SokobanMultiProcessEnv(seed=seed, env_num=env_num, group_n=group_n, mode=mode, is_train=is_train, env_kwargs=env_kwargs, resources_per_worker=resources_per_worker)