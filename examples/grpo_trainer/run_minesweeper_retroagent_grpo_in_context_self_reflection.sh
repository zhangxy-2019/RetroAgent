...
export RUN_NAME=agent_training_grpo_rl_minesweeper_qwen25_7b_instruct_intrinsic_rewards_both_attempt_mem_half_group_credit_assignment_sim_utility_ucb_large_penalty_gen2048
export HDFS_CHECKPOINT_PATH=./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_minesweeper/ckpts
mkdir -p $HDFS_CHECKPOINT_PATH
export HYDRA_FULL_ERROR=1
export REFLECTION_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_minesweeper/memory_cache/agent_training_grpo_rl_minesweeper_qwen25_7b_instruct_intrinsic_rewards_both_attempt_mem_half_group_credit_assignment_sim_utility_ucb_large_penalty_gen2048/minesweeper_reflections.json"
export REFLECTION_ANALYSIS_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_minesweeper/memory_cache/agent_training_grpo_rl_minesweeper_qwen25_7b_instruct_intrinsic_rewards_both_attempt_mem_half_group_credit_assignment_sim_utility_ucb_large_penalty_gen2048/reflect_analysis.jsonl"
export TRAJECTORY_ANALYSIS_FILE="./xiaoyingzhang/agent_training/qwen25_7b_instruct_retroagent_grpo_minesweeper/memory_cache/agent_training_grpo_rl_minesweeper_qwen25_7b_instruct_intrinsic_rewards_both_attempt_mem_half_group_credit_assignment_sim_utility_ucb_large_penalty_gen2048/trajectory_analysis.jsonl"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_agent_minesweeper' \
