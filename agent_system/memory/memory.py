...
class ReflectionMemory:
    def __init__(self, 
        ...
        if os.path.exists("./zhangxiaoying/save_vl_data/models/sentence-transformers/all-MiniLM-L6-v2"):
            self.model = SentenceTransformer("./zhangxiaoying/save_vl_data/models/sentence-transformers/all-MiniLM-L6-v2")
        else:
