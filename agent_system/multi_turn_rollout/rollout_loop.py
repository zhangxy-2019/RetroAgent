...
class TrajectoryCollector:
    ...
    def vanilla_multi_turn_loop(
        ...
        if is_train:
            ...
            batch_input_padded, pad_size = pad_dataproto_to_divisor(batch_input, reflect_wg.world_size)
            batch_output_padded = reflect_wg.generate_sequences(batch_input_padded)
            batch_output = unpad_dataproto(batch_output_padded, pad_size=pad_size)
            ...
            # if not self.enable_intrinsic_rewards:
            #     reflection_coeff = 0
            # else:
            ...
            # Calculate the coefficient based on the passed arguments
        ...
        return total_batch_list, episode_rewards, episode_lengths, success, traj_uid, tool_callings, trajectory_reflection_types, trajectory_retrieval_groups
    ...
    def dynamic_multi_turn_loop(
        ...
        while len(total_batch_list) < self.config.data.train_batch_size * self.config.env.rollout.n and try_count < max_try_count:
            ...
            batch_list, episode_rewards, episode_lengths, success, traj_uid, tool_callings, reflection_types, retrieval_groups = self.vanilla_multi_turn_loop(
                gen_batch=gen_batch,
        ...
        return total_batch_list, total_episode_rewards, total_episode_lengths, total_success, total_traj_uid, total_tool_callings, total_reflection_types, total_retrieval_groups
    ...
    def multi_turn_loop(
        ...
        if self.config.algorithm.filter_groups.enable and is_train:
            total_batch_list, total_episode_rewards, total_episode_lengths, total_success, total_traj_uid, total_tool_callings, total_reflection_types, total_retrieval_groups = \
